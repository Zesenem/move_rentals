    ...
    <div className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        ...
        <div className="mt-24 space-y-4 max-w-3xl mx-auto">
          <p className="text-lg text-space card-animate" style={{ animationDelay: "200ms" }}>
            ...
            scooters for rent — perfect for exploring every corner of this beautiful city at your
            own pace.
          </p>
          <p className="text-lg text-space card-animate" style={{ animationDelay: "300ms" }}>
            Whether you’re here for a day or a week, our local team is here to help you ride safely
            and smoothly. No hidden fees, no hassle — just freedom on two wheels. Your ride. Your
            rules. Lisbon awaits.
          </p>
        </div>
