  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        ...
        >
          Explore Lisbon with Confidence At Move Rentals, we make getting around Lisbon easy, fun,
          and worry-free. Located in the heart of the city, we offer reliable, well-maintained
          scooters for rent — perfect for exploring every corner of this beautiful city at your own
          pace. </p>
        <p className="mt-4 max-w-2xl mx-auto text-lg text-space card-animate">
          Whether you’re here for a day or a week, our local team is here to help you ride
          safely and smoothly. No hidden fees, no hassle — just freedom on two wheels. Your ride.
          Your rules. Lisbon awaits.
        </p>
